...
var logsCmd = &cobra.Command{
	Use:   "logs",
	Short: "View OpenPilot logs",
	Long:  `View the logs generated by OpenPilot for debugging and monitoring.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		logsDir := filepath.Join(cfg.WorkingDir(), cfg.Options.DataDirectory, "logs")
		logsFile := filepath.Join(logsDir, "openpilot.log")
		if _, statErr := os.Stat(logsFile); os.IsNotExist(statErr) {
			log.Warn("No log file found (expected openpilot.log); are you in the project directory?")
			return nil
		}
