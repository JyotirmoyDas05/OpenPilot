...
import (
	...
	"github.com/JyotirmoyDas05/openpilot/internal/lsp/protocol"
...
func (h *header) View() string {
	...
	b.WriteString(t.S().Base.Foreground(t.Secondary).Render("Surya™"))
	b.WriteString(gap)
	b.WriteString(styles.ApplyBoldForegroundGrad("OpenPilot", t.Secondary, t.Primary))
	b.WriteString(gap)
